@extends('admin.layouts.app', ['title' => 'Thêm Loại khóa tập'])
@section('styles')
  <base href="{{asset(' ')}}">
  <!-- summernote -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Thêm Loại Khóa Tập</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              @if(count($errors) >0)
                ...
                @endif
              <form action="{{route('admin-post-add-course-type')}}" method="POST" enctype="multipart/form-data">
