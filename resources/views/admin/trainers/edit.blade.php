@extends('admin.layouts.app', ['title' => 'Thay đổi thông tin huấn luyện viên'])
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Sửa Thông Tin Huấn Luyện Viên</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              @if(count($errors) >0)
                ...
                @endif
              <form action="{{route('admin-edit-trainer',['id'=>$trainer->id])}}" method="POST" enctype="multipart/form-data">
