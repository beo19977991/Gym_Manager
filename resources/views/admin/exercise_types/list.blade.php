              ...
              <input type="text" id="myInput" placeholder="Tìm theo tên">
                ...
                @foreach($exercise_types as $exercise_type)
                  <tr>
                    ...
                    <td><i class="ion-paintbrush" ></i> &nbsp;<a href="{{ route('admin-edit-exercise-type',['id'=>$exercise_type->id])}}">Sửa</a></br>
                    <i class="ion-ios-trash"></i> &nbsp;<a href="{{ route('admin-delete-exercise-type',['id'=>$exercise_type->id])}}" data-method="DELETE" data-confirm="Bạn chắc chắn muốn xóa {{$exercise_type->exercise_type_name}}" class="delete">Xóa</a></td>
                  </tr>
                @endforeach
                  </tbody>
                  <tfoot>
