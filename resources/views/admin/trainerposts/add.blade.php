@extends('admin.layouts.app', ['title' => 'Thêm Bài viết'])
@section('styles')
  <base href="{{asset(' ')}}">
  <!-- summernote -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              @if(count($errors) >0)
                ...
                @endif
              <form action="{{route('admin-add-trainer-post')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Tóm Tắt</label>
                    <input type="text" name="preview" class="form-control" id="address" placeholder="Nhập tóm tắt">
                  </div>
                  <div class="form-group">
