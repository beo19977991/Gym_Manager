@extends('staff.layouts.app', ['title' => 'Edit Course'])
@section('styles')
  <base href="{{asset(' ')}}">
  <!-- summernote -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              @if(count($errors) >0)
                ...
                @endif
              <form action="{{route('staff-edit-course',['id'=>$course->id])}}" method="POST" enctype="multipart/form-data">
...
<script>
  $(function () {
    ...
    $('#course_type').change(function(){
      ...
      $.get("manager/ajax/get_trainer_edit_course/"+course_type_id,function(data){
        $('#trainer').html(data);
      });
    });
