@extends('trainer.layouts.app', ['title' => 'Course Detail'])
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Danh sách khách hàng trong khóa tập - <strong>{{$course->course_name}}</strong></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <input type="text" id="myInput" placeholder="Tìm theo tên">
                <table id="example2" class="table table-bordered table-hover myTable mt-3">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td><a href="{{route('trainer-user-detail',['id'=>$user->id])}}" target="_blank" rel="noopener noreferrer">{{$user->full_name}}</a> </td>
                        <td>{{$user->email}}</td>
                        <td>{{$user->address}}</td>
                        <td>{{$user->age}}</td>
                        <td>
