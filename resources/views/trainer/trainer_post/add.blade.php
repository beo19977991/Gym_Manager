@extends('trainer.layouts.app', ['title' => 'Thêm Bài viết'])
@section('styles')
  <base href="{{asset(' ')}}">
  <!-- summernote -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              @if(count($errors) >0)
                ...
                @endif
              <form action="{{route('trainer-add-post')}}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <div class="card-body">
                  <div class="form-group">
                    <label>Bài viết</label>
                    <input type="text" name="title" class="form-control" id="address" placeholder="Nhập Tên bài viết">
                  </div>
                  <div class="form-group">
                    <label>Tóm Tắt</label>
                    <input type="text" name="preview" class="form-control" id="address" placeholder="Nhập tóm tắt bài viết">
                  </div>
                  <div class="form-group">
