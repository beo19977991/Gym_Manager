@extends('trainer.layouts.app', ['title' => 'Sửa Loại Bài tập'])
@section('styles')
  <base href="{{asset(' ')}}">
  <!-- summernote -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Sửa Loại Bài Tập</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              @if(count($errors) >0)
                ...
                @endif
              <form action="{{route('trainer-edit-exercise-type',['id'=>$exercise_type->id])}}" method="POST" enctype="multipart/form-data">
