...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Đầu",sLast:"Cuối",sNext:"Sau",sPrevious:"Trước"},sEmptyTable:"Không tìm thấy dữ liệu",sInfo:"Hiển thị _START_ đến _END_ trong tổng số _TOTAL_ bản ghi",sInfoEmpty:"Không có bản ghi nào",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",
